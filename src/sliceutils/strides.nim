...
proc by*[T, U](base: T, step: U): Stride[T, U] {.inline.} =
  ## Initializes a stride with base `base` and step `step`.
  Stride[T, U](base: base, step: step)

proc by*[T, U, V](s: HSlice[T, U], step: U): StridedSlice[T, U, V] {.inline.} =
  ## Initializes a stride with over the slice `s` with step `step`.
  s.a.by(step) .. s.b

proc contains*[T, U, V, W](s: StridedSlice[T, U, V], x: W): bool =
...
type
  LenableEnd[T, U] = concept b
    var
      base: T
      step: U
    compiles(int((b - base + step) div step)) or
      compiles(int((b - base + step) / step))

proc len*[T, U; V: LenableEnd[T, U]](s: StridedSlice[T, U, V]): int {.inline.} =
...
iterator items*[T, U, V](s: StridedSlice[T, U, V]): auto =
  ## Iterates over ``s``.
  var x = s.a.base
  while x <= s.b:
    yield x
...
proc `[]`*[I: Ordinal, T, U, V](s: StridedSlice[T, U, V], i: I): auto {.inline.} =
  ## Returns the number given at the `i` th iteration over `s`.
  s.a.base + s.a.step * U(i)

proc `[]`*[T, U, V](s: StridedSlice[T, U, V], i: BackwardsIndex): auto {.inline.} =
  ## Returns the number given at the `i` th iteration starting from the end over `s`.
  s[s.len - i.int]

proc `[]`*[I: Ordinal; T, U, V](s: StridedSlice[T, U, V], i: HSlice[I, I]): auto {.inline.} =
  ## Returns ``s[i.a] .. s[i.b]``.
  s[i.a].by(s.a.step) .. s[i.b]

proc `[]`*[I: Ordinal; T, U, V](s: StridedSlice[T, U, V], i: HSlice[I, BackwardsIndex]): auto {.inline.} =
  ## Returns ``s[i.a] .. s[i.b]``.
  s[i.a].by(s.a.step) .. s[i.b]

proc `[]`*[I: Ordinal; T, U, V](s: StridedSlice[T, U, V], i: HSlice[BackwardsIndex, I]): auto {.inline.} =
  ## Returns ``s[i.a] .. s[i.b]``.
  s[i.a].by(s.a.step) .. s[i.b]

proc `[]`*[T, U, V](s: StridedSlice[T, U, V], i: HSlice[BackwardsIndex, BackwardsIndex]): auto {.inline.} =
  ## Returns ``s[i.a] .. s[i.b]``.
  s[i.a].by(s.a.step) .. s[i.b]